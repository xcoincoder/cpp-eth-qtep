...
////////////////////////////////////////////////////////////// // qtep
    void setQtepSchedule(EVMSchedule _qtepSchedule) const { qtepSchedule = _qtepSchedule; }

    EVMSchedule& getQtepSchedule() const { return qtepSchedule; }
...
private:
    ...
    mutable EVMSchedule qtepSchedule; // qtep
